...
/* Define to 1 if `msg_controllen' is member of `struct msghdr'. */
/* #undef HAVE_STRUCT_MSGHDR_MSG_CONTROLLEN */
...
#define PACKAGE_STRING "nagios-plugins 2.1.2"
...
#define PS_COMMAND "/bin/ps axwwo 'stat uid pid ppid vsz rss pcpu cgroup:256 comm args'"
