...
function addHook(hook) {
  ...
  // This prevents that.
  var originalJSLoader = _module2.default._extensions['.js'];
  ...
  exts.forEach(function (ext) {
    ...
    var oldLoader = _module2.default._extensions[ext] || originalJSLoader;
    oldLoaders[ext] = oldLoader;

    loaders[ext] = _module2.default._extensions[ext] = function newLoader(mod, filename) {
      var compile = void 0;
      if (!reverted) {
  ...
  return function revert() {
    ...
    exts.forEach(function (ext) {
      ...
      if (_module2.default._extensions[ext] === loaders[ext]) {
        _module2.default._extensions[ext] = oldLoaders[ext];
      }
    });
  };
}